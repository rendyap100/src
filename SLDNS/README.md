# SLDNS
SSH OVER DNS create by rendyap100 
* Link Script Repo SlowDNS dari rendyap100
```html
https://raw.githubusercontent.com/rendyap100/izinvps/ipuk/SLDNS
```

Script Auto Installer SlowDNS
```html
wget -q -O /usr/bin/install-sldns "https://raw.githubusercontent.com/rendyap100/izinvps/ipuk/SLDNS/install-sldns"
